Feature: create contact to app contact
  ...
  Scenario: Login, crear contacto y validar existencia
    ...
    * def randomEmail = 'testcontact' + java.util.UUID.randomUUID() + '@hotmail.com'
    ...
    And request { "firstName": "Juan", "lastName": "Silva", "birthdate": "1990-01-01", "email":"#(randomEmail)", "phone": "8005555555", "street1": "1 Main St.", "street2": "Apartment A", "city": "Anytown", "stateProvince": "KS", "postalCode": "12345", "country": "USA" }
    When method POST
    Then status 201
